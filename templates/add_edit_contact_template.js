        ...
        <main class="contact_overlay_wrapper">
            ...
            <section class="contact_right_container">
                <div class="close_btn_container">
                    <img class="close_btn" src="./assets/img/x.svg" alt="Close Button" onclick="closeAddContactDialog()" role="button" aria-label="Schließen">
                </div>
                <div class="right_container_wrapper">
                    ...
                    <div>
                        ...
                        <div class="contact_btn_area">
                            <button class="outline_btn" onclick="closeAddContactDialog()">Cancel
                            ...
                            <button class="filled_btn">Create Contact<img src="./assets/img/check_white.svg" alt="Create Task"></button>
                        </div>
                    </div>
                </div>    
            </section>
...
function editContactTemplate(){
    return `
        <main class="contact_overlay_wrapper">
            ...
            <section class="contact_right_container">
                <div class="close_btn_container">
                    <img class="close_btn" src="./assets/img/x.svg" alt="Close Button" onclick="closeEditContactDialog()" role="button" aria-label="Schließen">
                </div>
                <div class="right_container_wrapper">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="contact_btn_area">
                            <button class="outline_btn" onclick="clearContactInputs()">Delete
                                <img class="icon default" src="./assets/img/close.svg" alt="Clear Formular">
                                <img class="icon hover" src="./assets/img/close_blue.svg" alt="Clear Formular Hover">
                            </button>
                            <button class="filled_btn">Save<img src="./assets/img/check_white.svg" alt="Create Task"></button>
                        </div>
                    </div>
                </div>    
            </section>
